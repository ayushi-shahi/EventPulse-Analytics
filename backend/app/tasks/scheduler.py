...
def start_scheduler():
    ...
    defaults = dict(max_instances=1, coalesce=True, misfire_grace_time=30)

    scheduler.add_job(process_event_batch,       IntervalTrigger(seconds=5),     id="ingest",    replace_existing=True, **defaults)
